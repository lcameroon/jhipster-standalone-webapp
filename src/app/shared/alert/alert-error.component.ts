...
import { JhiEventManager, JhiAlertService } from '../../../lib/ng-jhipster';
...
export class JhiAlertErrorComponent implements OnDestroy {
                    ...
                    case 400:
                        ...
                        arr.forEach(entry => {
                            if (entry.endsWith('app-error')) {
                                errorHeader = httpErrorResponse.headers.get(
                                    entry
                                );
                            } else if (entry.endsWith('app-params')) {
                                entityKey = httpErrorResponse.headers.get(
                                    entry
                                );
                            }
                        });
    ...
    ngOnDestroy() {
        if (
            this.cleanHttpErrorListener !== undefined &&
            this.cleanHttpErrorListener !== null
        ) {
