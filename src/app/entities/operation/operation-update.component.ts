...
import { JhiAlertService } from '../../../lib/ng-jhipster';
...
import { LabelService } from '../../entities/label';
...
export class OperationUpdateComponent implements OnInit {
    ...
    private subscribeToSaveResponse(
        result: Observable<HttpResponse<IOperation>>
    ) {
        result.subscribe(
            (res: HttpResponse<IOperation>) => this.onSaveSuccess(),
